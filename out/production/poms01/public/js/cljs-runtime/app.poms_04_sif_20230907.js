goog.provide('app.poms_04_sif_20230907');
 ...
 */
app.poms_04_sif_20230907.create_root = (function app$poms_04_sif_20230907$create_root(var_args){
var G__81929 = arguments.length;
switch (G__81929) {
case 1:
return app.poms_04_sif_20230907.create_root.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));

break;
case 2:
return app.poms_04_sif_20230907.create_root.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));
...
(app.poms_04_sif_20230907.create_root.cljs$core$IFn$_invoke$arity$1 = (function (node){
return app.poms_04_sif_20230907.create_root.cljs$core$IFn$_invoke$arity$2(node,cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.gensym.cljs$core$IFn$_invoke$arity$0()));
}));

(app.poms_04_sif_20230907.create_root.cljs$core$IFn$_invoke$arity$2 = (function (node,id_prefix){
return module$node_modules$react_dom$client.createRoot(node,({"identifierPrefix": id_prefix}));
}));

(app.poms_04_sif_20230907.create_root.cljs$lang$maxFixedArity = 2);

app.poms_04_sif_20230907.render = (function app$poms_04_sif_20230907$render(var_args){
var args__5775__auto__ = [];
var len__5769__auto___81959 = arguments.length;
var i__5770__auto___81960 = (0);
while(true){
if((i__5770__auto___81960 < len__5769__auto___81959)){
args__5775__auto__.push((arguments[i__5770__auto___81960]));

var G__81961 = (i__5770__auto___81960 + (1));
i__5770__auto___81960 = G__81961;
continue;
} else {
}
break;
...
return app.poms_04_sif_20230907.render.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5776__auto__);
});

(app.poms_04_sif_20230907.render.cljs$core$IFn$_invoke$arity$variadic = (function (root,args){
...
(app.poms_04_sif_20230907.render.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(app.poms_04_sif_20230907.render.cljs$lang$applyTo = (function (seq81933){
var G__81934 = cljs.core.first(seq81933);
var seq81933__$1 = cljs.core.next(seq81933);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__81934,seq81933__$1);
}));

app.poms_04_sif_20230907.data = (function app$poms_04_sif_20230907$data(db){
return cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__81942){
var vec__81943 = p__81942;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81943,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81943,(1),null);
var company = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81943,(2),null);
var user__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81943,(3),null);
...
app.poms_04_sif_20230907.MyComponent = (function app$poms_04_sif_20230907$MyComponent(data){
...
//# sourceMappingURL=app.poms_04_sif_20230907.js.map
